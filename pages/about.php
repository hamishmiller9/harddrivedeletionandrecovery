    ...
    <div class="content-wrapper">
        ...
        <div class="main-content">
            ...
            <h3>What is secure deletion?</h3>
                <p>Secure data deletion is the practice of erasing or overwriting all traces of existing data from a storage device, with the original data becoming inaccessible with no possibility of reconstruction (IBM, 2025). This differs from methods like the Recycle Bin, of which only marks sectors as available for reuse, without overwriting or removing the data (Metabase, 2025). Failure to securely delete data can have severe consequences. The ICO provide guidance for organisations on securely disposing of electronic data, emphasising the importance of using secure data deletion methods. The ICO states “if personal information in electronic records is not destroyed securely, it may be recoverable. This may breach GDPR articles 5(1)(f) and 32” (Information Commissioner’s Office, 2024b), of which requires organisations to process data securely, protected against unauthorised access, loss or destruction.</p>
                <p>Furthermore, the increasing threat of cyber-crime, as highlighted in the Cyber Security Breaches Survey 2024 (Department for Science, Innovation and Technology (DSIT), 2024), underscores the importance of effective data sanitisation methods, with cyber-criminals exploiting improperly disposed data to retrieve confidential information. This risk extends beyond professional environments to personal users, who may be susceptible to private data exposure if old devices are disposed of without ensuring adequate data sanitation. By highlighting reliable deletion techniques, this project aims to increase awareness into security and privacy and prevent potential security breaches.</p>
